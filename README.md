...
-Detect customers with high sales but negative profit
...
2️. Profit Distribution
  Analyzed overall customer profit distribution
  Identified customers contributing to major losses
3️. Discount vs Customer Profit
  High discounts (especially above 20%–50%) are strongly linked to losses
  Some customers show high sales volume but negative profit due to heavy discounting
4️.Loss-Making Customers
  Top loss-making customers were identified
...
─ visuals/
   ─ customer_profit_distribution.png
   ─ discount_vs_customer_profit.png
   ─ top_loss_making_customers.png
─ README.md
